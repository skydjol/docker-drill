...
COPY apache-drill-1.4.0.tar.gz .
RUN tar zxpf apache-drill-1.4.0.tar.gz -C /opt/drill
...
CMD /drill-scripts/bootstrap.sh && tail -f /opt/drill/apache-drill-1.4.0/log/drillbit.out
